...
export default function Login() {
  ...
  return (
    <div className="auth-card">
      <div className="mb-7">
        <p className="mb-2 text-[10px] font-black uppercase tracking-widest text-primary">Player and owner access</p>
        <h1 className="text-3xl font-black text-slate-900 mb-2">Welcome back</h1>
        <p className="text-sm font-bold text-slate-500">Sign in to book courts, join matches, or manage your venue.</p>
      </div>
