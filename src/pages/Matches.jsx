    ...
    <main className="max-w-[1280px] mx-auto pb-24">
      <section className="px-6 pt-12 pb-8">
        <div className="flex flex-col gap-4 mb-10">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl">Connect with players of your skill level and hit the court today. No partner? No problem.</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 mb-12">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button className="bg-primary text-white font-black px-10 py-4 rounded-xl flex items-center justify-center gap-2 hover:brightness-110 transition-all shadow-lg shadow-primary/30 active:scale-[0.98]">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                      <div className="bg-slate-50 dark:bg-slate-900/50 p-3 rounded-xl border border-slate-100 dark:border-slate-700">
                        ...
                        <p className="text-lg font-black text-primary">${match.pricePerPerson || 8}</p>
                      </div>
                      <div className="bg-slate-50 dark:bg-slate-900/50 p-3 rounded-xl border border-slate-100 dark:border-slate-700">
                    ...
                    <div className="mt-auto">
                      <button className="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-4 rounded-xl font-black hover:bg-primary dark:hover:bg-primary dark:hover:text-white transition-all shadow-xl active:scale-[0.98]">
                        Request to Join
                      </button>
                    </div>
                  </div>
      ...
      <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-40">
        <button className="flex items-center gap-4 bg-primary text-white px-8 py-5 rounded-full shadow-[0_20px_50px_rgba(34,197,94,0.4)] hover:scale-105 active:scale-95 transition-all border border-white/20 backdrop-blur-lg group">
